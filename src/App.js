...
const App = (props) => {
  ...
  return ( 
    <Router>
        ...
        <Route path = "/sign-up" exact render = { (props) => auth ?  <Signup {...props}  /> : <Redirect to = "/" /> }></Route>

        <Route path="/contact-us"  exact render = { (props) => auth ?  <ContactUs {...props}/> : <Redirect to = "/sign-in" />   }></Route>

        <Route path = "/sign-in" exact render = { (props) => auth ?  <Signin {...props} />: <Redirect to = "/" />  }></Route>
